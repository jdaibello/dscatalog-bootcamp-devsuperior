...
public class ProductResourceTests {
	...
	@Test
	public void deleteShouldReturnNotFountExceptionContentWhenIdDoesNotExist() throws Exception {
	...
	public void updateShouldReturnProductDTOWhenIdExists() throws Exception {
		...
		String expectedDescription = newProductDTO.getDescription();
		String expectedImgUrl = newProductDTO.getImgUrl();
